...
def evaluate_model(random_forest, X_test, y_test, stress_type):
...
if __name__ == '__main__':
    ...
    classify_planar_compression()
    classify_planar_tension()
    classify_simple_shear()
    classify_uniax_compression()
    classify_uniax_tension()
